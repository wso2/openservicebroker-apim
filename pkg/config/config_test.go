...
func TestSetDefaultConf(t *testing.T) {
	...
	testStringConf(t, "apim.dynamicClientRegistrationContext", "/client-registration/v0.16/register")
	testStringConf(t, "apim.publisherEndpoint", "https://localhost:9443")
	testStringConf(t, "apim.publisherAPIContext", "/api/am/publisher/v1/apis")
	testStringConf(t, "apim.storeEndpoint", "https://localhost:9443")
	testStringConf(t, "apim.storeApplicationContext", "/api/am/store/v1/applications")
	testStringConf(t, "apim.storeSubscriptionContext", "/api/am/store/v1/subscriptions")
